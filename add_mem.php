...
include("conn.php");
	...
	}else 
	{
	 ...
	 if($result->num_rows==0)
	 {
		...
		?>
				<script>
					var sessionName1 = '<?php echo "ยินดีด้วยค่ะ ขณะนี้ คุณ "; echo $fname; echo " ได้เป็นสมาชิกของเราแล้วค่ะ";?>';
					alert( sessionName1 );
				</script>
	 ...
	 { 
		?>
			 <script>
					var sessionName1 = '<?php echo "username "; echo $username; echo " มีผู้ใช้งานแล้ว กรุณากรอกใหม่ด้วยค่ะ";?>';
					alert( sessionName1 );
				</script>
