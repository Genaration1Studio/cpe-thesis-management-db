							...
							<tr style="text-align: center">	 
								 ...
								 ?>
										  ...
										  <td style="text-align: center" width="8%">
											<img src="images/baseline_border_color_black_36dp.png" width="20px" data-toggle="tooltip" data-placement="bottom" title="แก้ไข"  name="edit" value="edit" id="<?php echo $row->pid; ?>" class="edit"/>
											 &ensp;
											  <a  href="del_pro.php?pid=<?=$row->pid;?>" onClick="ts();">
											  <img src="images/baseline_delete_forever_black_36dp.png" width="20px" data-toggle="tooltip" data-placement="bottom" title="ลบ" onClick="return confirm('ต้องการลบข้อมูลผู้จัดทำ รหัส <?php echo $row->pid;?> ใช่หรือไม่')"/></a>
										  </td>
										  </tr>
								<?php
											 $ct++;
