							...
							<tr style="text-align: center">	 
								 ...
								 ?>
										  ...
										  <td style="text-align: center">
											<img src="images/baseline_border_color_black_36dp.png" width="20px" data-toggle="tooltip" data-placement="bottom" title="แก้ไข"  name="edit" value="edit" id="<?php echo $row->cosid; ?>" class="edit"/>
											 &ensp;
											  <a  href="del_cos.php?cosid=<?=$row->cosid;?>" onClick="ts();">
											  <img src="images/baseline_delete_forever_black_36dp.png" width="20px" data-toggle="tooltip" data-placement="bottom" title="ลบ" onClick="return confirm('ต้องการลบข้อมูลหลักสูตร รหัส <?php echo $row->cosid;?> ใช่หรือไม่')"/></a>
										  </td>
										  </tr>
								<?php
											 $ct++;
