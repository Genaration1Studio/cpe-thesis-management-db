								 ...
								 ?>
										 ...
										 <?php if($row->fname_th=="")
										  ...
										  <td style="text-align: center">
											<img src="images/baseline_border_color_black_36dp.png" width="20px" data-toggle="tooltip" data-placement="bottom" title="แก้ไข"  name="edit" value="edit" id="<?php echo $row->fid; ?>" class="edit"/>
											 &ensp;
											  <a  href="del_fac.php?fid=<?=$row->fid;?>" onClick="ts();">
											  <img src="images/baseline_delete_forever_black_36dp.png" width="20px" data-toggle="tooltip" data-placement="bottom" title="ลบ" onClick="return confirm('ต้องการลบข้อมูลคณะ รหัส <?php echo $row->fid;?> ใช่หรือไม่')"/></a>
										  </td>
										  </tr>
								<?php
											 $ct++;
