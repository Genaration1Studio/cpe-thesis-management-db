		...
		<div class="wrap-main">
			<form action="admin.php" class='needs-validation form-horizontal  table-striped' id="formsq" role='form' method="post" novalidate> 
				  ...
				  <div class="col-2" style="text-align: right">
		  				<a class="btn btn-success btn-sm" href="sh_add.php?page=<?php echo $page;?>" data-toggle="tooltip" data-placement="bottom" 
           ...
           <div class='col-md-2'>
             <select class='form-control cc-select font_ek_14' name="thesis_year" required>
					...
					<?php
							...
							{
						?>
							<option value="<?php echo $row->ty;?>"><?=$row->ty;?></option>
						<?php
							}
						?>
						 ...
						 <thead>
							<tr style="text-align: center">	 
								 ...
								 ?>
										  ...
										  <td><a href="sh_thesis_admin.php?tid=<?=$row->tid;?>" target="_blank"><?php echo $row->tn_th; ?></a></td>
										  <td><?php echo $row->tc_th; ?></td>
										  <td><?php echo $row->pn_th;?></td>
										  <td><?php echo $row->an_th;?></td>
										  <td style="text-align: center">
											 <a  href="sh_edit_thesis.php?tid=<?=$row->tid;?>"> <img src="images/baseline_border_color_black_36dp.png" width="20px" data-toggle="tooltip" data-placement="bottom" title="แก้ไข"/></a>
											 &ensp;
											   <a  href="del_thesis.php?tid=<?=$row->tid;?>" onClick="ts();">
											  <img src="images/baseline_delete_forever_black_36dp.png" width="20px" data-toggle="tooltip" data-placement="bottom" title="ลบ" onClick="return confirm('ต้องการลบข้อมูลปริญานิพนธ์ รหัส <?php echo $row->tid;?> ใช่หรือไม่')"/></a>
										  </td>
										  </tr>
								<?php
											 $ct++;
